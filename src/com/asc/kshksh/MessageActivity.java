...
public final class MessageActivity extends ListActivity
{
	...
	ToneGenerator tg; 
	 ...
	 String recipientID = "noamltaasan@gmail.com";
	 String senderCode = "7"; 
	 String recipientCode = "1";
	...
	public void onCreate(Bundle savedInstanceState) {
	     ...
	     fileName = senderCode + "." + recipientCode + ".3gpp"; 
	     ...
	     lv.setOnItemClickListener(  new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Toast.makeText(ctx,  Integer.toString(arg2) + myContacts[arg2], Toast.LENGTH_SHORT).show();
				// here we star the MessageActivity after defining senderID, recipientID
    ...
    private void stopRecording() throws Exception {
        if (recorder != null) {
            ...
            setValue(ctx, "fileName", OUTPUT_FILE);
            setValue(ctx,"senderID",senderID); 
            setValue(ctx,"recipientID",recipientID); 
